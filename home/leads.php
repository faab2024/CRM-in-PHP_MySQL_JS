...
//fetching data in descending order (lastest entry first)
$result = mysqli_query($mysqli, "SELECT * FROM  leads  WHERE client=".$_SESSION['id']." AND date_reg LIKE '%".$Date_reg."%' ORDER BY name ASC LIMIT $Filt");
...
//fetching data in descending order (lastest entry first)
$resul = mysqli_query($mysqli, "SELECT * FROM leads WHERE client=".$_SESSION['id']." AND name LIKE '%".$Key."%' ORDER BY name ASC");
}
?>
...
<center>
     ...
     <div class="table-responsive text-nowrap">
          ...
          <table class="table table-striped">
           ...
           <center> <h3>Available Leads</h3></center>
           <center>
