...
$result = mysqli_query($mysqli, "SELECT * FROM  contacts  WHERE client=".$_SESSION['id']."");
...
$sql="INSERT INTO contacts(name,email,phone,location,client,business_phone,website,business_name,lead_status,business_industry,lead_score) 
VALUES
...
<div class="menu">
    ...
    <?php include 'nav.php';?>
        ...
        <center> <h1>Manual Contact Entry </h1> 
