...
<body>
<div id="headline"><h1>AI Unlimited Leads&Contacts Generator<img src="key_question.png" title="Generate Unlimited Leads and Contacts Using this AI-based Feature" /> </h1></div>
<div id="container">
<form action="create.php" method="post">
	<input class="field" type="number" name="numField" id="numField" placeholder="Enter number of Lead To Generate (up to 2000 each time)" />
	<input class="field" type="number" name="userField" id="userField" placeholder="Enter length of usernames (1-24)" />
	<input type="Submit" class="myButton" id="submit" value="Generate Leads" />
</form>
